  ...
  return (
    <div className="group w-full flex items-center bg-[#25273c] text-[#b2b4cd] pt-5 pb-5 pl-3">
          <div className="relative">
            <div className={`relative w-6 h-6 ${checked ? 'bg-gradient-to-r from-[#70bdfb] to-[#a476e8]' : 'bg-transparent'} rounded-full border-[2px] cursor-pointer border-[#323449] hover:border-[#70bdfb] duration-500`} onClick={OnClickRoundBtn}>
