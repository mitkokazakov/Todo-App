    ...
    <div className="w-[90%] mr-auto ml-auto text-white flex flex-col justify-center items-center gap-5 translate-y-[-150px] md:w-[700px] md:translate-y-[-200px]">
      <div className=" flex justify-between items-center w-full">
        ...
        <div className="w-6 h-6 cursor-pointer relative">
          <img
            className={`w-full h-full cursor-pointer absolute top-0 left-0 duration-500 opacity-100 dark:opacity-0`}
            src={moon}
            alt=""
            onClick={darkThemeHandler}
          />
          <img
            className={`w-full h-full cursor-pointer absolute top-0 left-0 duration-500 opacity-0 dark:opacity-100`}
            src={sun}
            alt=""
            onClick={darkThemeHandler}
          />
